...
// v22.91 — Weights Hub: Pixel .txt import rebuilt (item-level parsing, real
// mapping tables validated against the Excel workbook, Dumpster Dive rollup,
// draught blend splits, 3 broken summary-table lookups fixed)
//
// RULE: bump CACHE every time index.html changes. Keep in lockstep with the
// two version badges in index.html.

const CACHE = 'fd-cc-v2291';
